...
class CustomerMenu extends Component
{
    ...
    public function editCartItem($index)
    {
        ...
        $this->selectedMenu = Menu::with("options.items")->find(
            $item["menu_id"],
        );
    ...
    public function submitOrder()
    {
        ...
        try {
            ...
            if ($activeOrder) {
                ...
                $newTaxAmount = $newSubtotal * 0.1; // Pajak 10% dari total baru
    ...
    {
        return view("components.customer.customer-menu")->layout(
